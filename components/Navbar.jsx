...
const Navbar = () => {
  return (
    <>
      <section id='navbar' className=" fixed top-0 z-10 w-full h-28  bg-600 px-6 items-center flex justify-between custome-bg rounded- drop-shadow-xl  ">
        ...
        <div className="text-white w-8/12 invisible md:visible">
          <ul className="flex justify-between items-center navbar-list ">
            ...
            <li className="bg-white rounded-full p-2 text-md font-medium  flex items-center "> 
              <input className="outline-none text-gray-600" placeholder="Search" ></input>
